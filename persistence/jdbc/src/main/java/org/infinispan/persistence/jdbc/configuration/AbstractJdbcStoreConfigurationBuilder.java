...
import static org.infinispan.persistence.jdbc.configuration.AbstractJdbcStoreConfiguration.DB_DISABLE_UPSERT;
...
public abstract class AbstractJdbcStoreConfigurationBuilder<T extends AbstractJdbcStoreConfiguration, S extends AbstractJdbcStoreConfigurationBuilder<T, S>> extends
   ...
   public S dbDisableUpsert(boolean disable) {
      attributes.attribute(DB_DISABLE_UPSERT).set(disable);
      return self();
   }
