 ...
 * @author Ryan Emerson
 */
public class PostgresTableManager extends AbstractTableManager {

   private static final Log LOG = LogFactory.getLog(SybaseTableManager.class, Log.class);

   public PostgresTableManager(ConnectionFactory connectionFactory, TableManagerConfiguration config, DbMetaData metaData) {
   ...
   public boolean isUpsertSupported() {
      ...
      return metaData.getMajorVersion() > 8 && metaData.getMinorVersion() > 4;
   }
