...
public class HikariConnectionPool implements ConnectionPool {
   ...
   private Properties loadPropertiesFile(ClassLoader classLoader, PooledConnectionFactoryConfiguration poolConfig) {
      ...
      try {
         ...
         log.error(String.format("Error loading HikariCP properties file, only the properties set in %s will be loaded",
                                 PooledConnectionFactoryConfiguration.class.getName()));
      }
      return new Properties();
   }
