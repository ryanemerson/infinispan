...
public class ConnectionPoolConfiguration {
   ...
   static final AttributeDefinition<ExhaustedAction> EXHAUSTED_ACTION = AttributeDefinition.builder("exhaustedAction", null, ExhaustedAction.class).immutable().build();
   ...
   public int maxActive() {
      return attributeDefinitionSet().attribute(MAX_ACTIVE).get();
   }
