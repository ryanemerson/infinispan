...
{brandname}'s link:{javadocroot}/org/infinispan/functional/FunctionalMap.html[Functional Map API]
...
For those operations that return multiple results, the API returns instances of a link:{javadocroot}/org/infinispan/functional/Traversable.html[Traversable] interface which offers a lazy pull-style API for working with multiple results.
...
link:{javadocroot}/org/infinispan/functional/FunctionalMap.ReadOnlyMap.html[`ReadOnlyMap`]
), read-write (
link:{javadocroot}/org/infinispan/functional/FunctionalMap.ReadWriteMap.html[`ReadWriteMap`]
) and write-only (
link:{javadocroot}/org/infinispan/functional/FunctionalMap.WriteOnlyMap.html[`WriteOnlyMap`]
...
Using
link:{javadocroot}/org/infinispan/functional/FunctionalMap.WriteOnlyMap.html[write-only map API]
...
* link:{javadocroot}/org/infinispan/functional/EntryView.WriteEntryView.html#set(V,org.infinispan.functional.MetaParam.Writable...)[`set(V, MetaParam.Writable...)`]
...
link:{javadocroot}/org/infinispan/functional/FunctionalMap.ReadWriteMap.html[read-write map API]
. Moreover, with
link:{javadocroot}/org/infinispan/functional/FunctionalMap.ReadWriteMap.html[read-write map API]
...
link:{javadocroot}/org/infinispan/functional/EntryView.ReadWriteEntryView.html[read-write entry view]
...
link:{javadocroot}/org/infinispan/functional/MetaParam.html[Metadata parameters]
...
link:{javadocroot}/org/infinispan/functional/MetaParam.MetaEntryVersion.html[`MetaEntryVersion<T>`]
...
link:{javadocroot}/org/infinispan/functional/FunctionalMap.html#withParams(org.infinispan.functional.Param...)[`withParams(Param<?>...)`]
method.

link:{javadocroot}/org/infinispan/functional/Param.FutureMode.html[`Param.FutureMode`]
...
link:{javadocroot}/org/infinispan/functional/Param.FutureMode.html#COMPLETED[`Param.FutureMode.COMPLETED`]
...
link:{javadocroot}/org/infinispan/functional/Listeners.WriteListeners.html[write listeners]
and
link:{javadocroot}/org/infinispan/functional/Listeners.ReadWriteListeners.html[read-write listeners].
...
link:{javadocroot}/org/infinispan/functional/Listeners.WriteListeners.html#add(org.infinispan.functional.Listeners.WriteListeners.WriteListener)[`add(WriteListener<K, V>)`]
method.
...
link:{javadocroot}/org/infinispan/functional/Listeners.ReadWriteListeners.ReadWriteListener.html#onCreate(java.util.function.Consumer)[`onCreate`]
,
link:{javadocroot}/org/infinispan/functional/Listeners.ReadWriteListeners.ReadWriteListener.html#onModify(java.util.function.BiConsumer)[`onModify`]
or
link:{javadocroot}/org/infinispan/functional/Listeners.ReadWriteListeners.ReadWriteListener.html#onRemove(java.util.function.Consumer)[`onRemove`]
...
interface via the
link:{javadocroot}/org/infinispan/functional/Listeners.ReadWriteListeners.html#add(org.infinispan.functional.Listeners.ReadWriteListeners.ReadWriteListener)[`ReadWriteListeners.add()`]
...
[source,java]
----
include::code_examples/WriteOnlyMapExternalizer.java[]
----
...
link:{jdkdocroot}/java/util/concurrent/ConcurrentMap.html[`ConcurrentMap`],
for example, if you want to do a replace operation using metadata parameter
equality instead of value equality, or if you want to retrieve metadata
information from values and so on.
