...
== Jakarta, Java EE and JCache

* Infinispan has been updated to use `jakarta.*` packages.
* If you require the legacy `javax.*` packages, you should utilise Infinispan 14.x.
* JCache support is no longer provided as the specification will not transition to Jakarta.
* The old `*-jakarta` jars have been removed.
