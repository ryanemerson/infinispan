...
public interface ProtoStreamTypeIds {
   ...
   int CLUSTER_BROADCAST_JOIN_COMMAND = LOCK_CONTROL_COMMAND + 1;
   int CLUSTER_REQUEST_JOIN_COMMAND = CLUSTER_BROADCAST_JOIN_COMMAND + 1;
   int MANAGER_STATUS_RESPONSE = CLUSTER_REQUEST_JOIN_COMMAND + 1;
   int MANAGER_VERSION = MANAGER_STATUS_RESPONSE + 1;
   int MERGE_FUNCTION = MANAGER_VERSION + 1;
