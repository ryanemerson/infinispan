...
public interface ProtoStreamTypeIds {
   ...
   int SUCCESSFUL_BYTES_RESPONSE = SUCCESSFUL_ARRAY_RESPONSE + 1;
   int SUCCESSFUL_COLLECTION_RESPONSE = SUCCESSFUL_BYTES_RESPONSE + 1;
   int SUCCESSFUL_MAP_RESPONSE = SUCCESSFUL_COLLECTION_RESPONSE + 1;
   int SUCCESSFUL_IMMORTAL_CACHE_VALUE_RESPONSE = SUCCESSFUL_MAP_RESPONSE + 1;
   int SUCCESSFUL_OBJECT_RESPONSE = SUCCESSFUL_IMMORTAL_CACHE_VALUE_RESPONSE + 1;
   int PREPARE_RESPONSE = SUCCESSFUL_OBJECT_RESPONSE + 1;
   ...
   int RESP_WATCH_TX_EVENT_CONVERTER_EMPTY = RESP_LOWER_BOUND + 9;
