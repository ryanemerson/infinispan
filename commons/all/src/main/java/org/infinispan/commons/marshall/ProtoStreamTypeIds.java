...
public interface ProtoStreamTypeIds {
   ...
   int HASH_CRC16 = COMMONS_LOWER_BOUND;
   int NULL_VALUE = COMMONS_LOWER_BOUND + 1;
   int XID_IMPL = COMMONS_LOWER_BOUND + 2;
   ...
   int IRAC_CLEANUP_KEYS_COMMAND = IRAC_METADATA + 1;
   int IRAC_MANAGER_KEY_INFO = IRAC_CLEANUP_KEYS_COMMAND + 1;
   ...
   int ROLE_SET = IRAC_UPDATE_VERSION_COMMAND + 1;
   int ROLE = ROLE_SET + 1;
   int AUTHORIZATION_PERMISSION = ROLE + 1;

   int PERSISTENCE_UUID = AUTHORIZATION_PERMISSION + 1;
   ...
   int XSITE_STATE = XSITE_EVENT_TYPE + 1;
