...
public interface ProtoStreamTypeIds {
   ...
   int MARSHALLABLE_COLLECTION = JGROUPS_TOPOLOGY_AWARE_ADDRESS + 1;
   ...
   int MARSHALLABLE_USER_COLLECTION = MARSHALLABLE_THROWABLE + 1;
   int MARSHALLABLE_USER_MAP = MARSHALLABLE_USER_COLLECTION + 1;
   int COMMAND_INVOCATION_ID = MARSHALLABLE_USER_MAP + 1;
   ...
   int CLEAR_COMMAND = CANCEL_PUBLISHER_COMMAND + 1;
