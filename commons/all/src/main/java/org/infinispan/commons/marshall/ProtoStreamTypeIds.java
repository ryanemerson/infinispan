...
public interface ProtoStreamTypeIds {
   ...
   int COUNTER_FUNCTION_ADD = COUNTER_STORAGE + 1;
   int COUNTER_FUNCTION_CAS = COUNTER_FUNCTION_ADD + 1;
   int COUNTER_FUNCTION_CREATE_AND_ADD = COUNTER_FUNCTION_CAS + 1;
   int COUNTER_FUNCTION_CREATE_AND_CAS = COUNTER_FUNCTION_CREATE_AND_ADD + 1;
   int COUNTER_FUNCTION_CREATE_AND_SET = COUNTER_FUNCTION_CREATE_AND_CAS + 1;
   int COUNTER_FUNCTION_INITIALIZE_COUNTER = COUNTER_FUNCTION_CREATE_AND_SET + 1;
   int COUNTER_FUNCTION_READ = COUNTER_FUNCTION_INITIALIZE_COUNTER + 1;
   int COUNTER_FUNCTION_REMOVE = COUNTER_FUNCTION_READ + 1;
   int COUNTER_FUNCTION_RESET = COUNTER_FUNCTION_REMOVE + 1;
   int COUNTER_FUNCTION_SET = COUNTER_FUNCTION_RESET + 1;
