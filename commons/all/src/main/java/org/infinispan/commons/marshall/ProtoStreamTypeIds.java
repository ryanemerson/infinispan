...
public interface ProtoStreamTypeIds {
   ...
   // JCache 6800 -> 6899
   int JCACHE_LOWER_BOUND = 6800;
   int JCACHE_GET_AND_PUT = JCACHE_LOWER_BOUND + 1;
   int JCACHE_GET_AND_REMOVE = JCACHE_LOWER_BOUND + 2;
   int JCACHE_GET_AND_REPLACE = JCACHE_LOWER_BOUND + 3;
   int JCACHE_INVOKE = JCACHE_LOWER_BOUND + 4;
   int JCACHE_MUTABLE_ENTRY_SNAPSHOT = JCACHE_LOWER_BOUND + 5;
   int JCACHE_PUT = JCACHE_LOWER_BOUND + 6;
   int JCACHE_PUT_IF_ABSENT = JCACHE_LOWER_BOUND + 7;
   int JCACHE_READ_WITH_EXPIRY = JCACHE_LOWER_BOUND + 8;
   int JCACHE_REMOVE = JCACHE_LOWER_BOUND + 9;
   int JCACHE_REMOVE_CONDITIONALLY = JCACHE_LOWER_BOUND + 10;
   int JCACHE_REPLACE = JCACHE_LOWER_BOUND + 11;
   int JCACHE_REPLACE_CONDITIONALLY = JCACHE_LOWER_BOUND + 12;
}
