...
public class CompositeKeyValueFilterConverter<K, V, C> implements KeyValueFilterConverter<K, V, C>, ExternalPojo {
   ...
   public static class Externalizer extends AbstractExternalizer<CompositeKeyValueFilterConverter> {
      @Override
      public Set<Class<? extends CompositeKeyValueFilterConverter>> getTypeClasses() {
         return Collections.singleton(CompositeKeyValueFilterConverter.class);
      }
