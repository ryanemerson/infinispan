...
public class PersistenceManagerAvailabilityTest extends AbstractInfinispanTest {
   ...
   public void testCacheAvailability() {
      ...
      cache.put(1, 1);
      TestingUtil.replaceComponent(cache, PersistenceManager.class, new AvailablePersistenceManager(new ByRef.Boolean(false)), true);
   ...
   private static class AvailablePersistenceManager extends PersistenceManagerImpl {
      ByRef.Boolean available;
      AvailablePersistenceManager(ByRef.Boolean available) {
