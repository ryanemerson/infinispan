...
public class ReplicatedControlledConsistentHashFactory implements ConsistentHashFactory<ReplicatedConsistentHash> {
   ...
   public static class Externalizer extends AbstractExternalizer<ReplicatedControlledConsistentHashFactory> {
      @Override
      public Set<Class<? extends ReplicatedControlledConsistentHashFactory>> getTypeClasses() {
         return Collections.singleton(ReplicatedControlledConsistentHashFactory.class);
      }
