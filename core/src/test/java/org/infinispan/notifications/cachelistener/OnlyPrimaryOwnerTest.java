...
public class OnlyPrimaryOwnerTest {
   ...
   private static class MockCDL implements ClusteringDependentLogic {
      private static final Address PRIMARY = JGroupsTopologyAwareAddress.random();
      private static final Address BACKUP = JGroupsTopologyAwareAddress.random();
      private static final Address NON_OWNER = JGroupsTopologyAwareAddress.random();
      ...
      public LocalizedCacheTopology getCacheTopology() {
         ...
         CacheTopology cacheTopology = new CacheTopology(0, 0, ch, null, CacheTopology.Phase.NO_REBALANCE, null);
