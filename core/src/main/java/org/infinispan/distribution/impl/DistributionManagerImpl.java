...
public class DistributionManagerImpl implements DistributionManager {
   ...
   void start() throws Exception {
      ...
      Address localAddress = transport == null ? JGroupsTopologyAwareAddress.LOCAL : transport.getAddress();
   ...
   public static LocalizedCacheTopology makeSingletonTopology(CacheMode cacheMode, KeyPartitioner keyPartitioner,
      ...
      CacheTopology cacheTopology = new CacheTopology(-1, -1, ch, null, CacheTopology.Phase.NO_REBALANCE, members);
