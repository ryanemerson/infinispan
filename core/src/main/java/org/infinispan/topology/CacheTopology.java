...
public class CacheTopology {
   ...
   // TODO remove usage from tests
   public CacheTopology(int topologyId, int rebalanceId, ConsistentHash currentCH, ConsistentHash pendingCH,
                        Phase phase, List<Address> actualMembers, List<PersistentUUID> ignore) {
      this(topologyId, rebalanceId, currentCH, pendingCH, null, phase, actualMembers);
   }

   // TODO remove usage from tests
   public CacheTopology(int topologyId, int rebalanceId, ConsistentHash currentCH, ConsistentHash pendingCH,
                        ConsistentHash unionCH, Phase phase, List<Address> actualMembers, List<PersistentUUID> ignore) {
      this(topologyId, rebalanceId, currentCH, pendingCH, unionCH, phase, actualMembers);
   }
