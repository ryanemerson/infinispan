...
public class RemoveExpiredCommand extends RemoveCommand {
   ...
   RemoveExpiredCommand(MarshallableObject<?> wrappedKey, long flagsWithoutRemote, int topologyId, int segment,
                        ...
                        PrivateMetadata internalMetadata, Long lifespan) {
      super(wrappedKey, flagsWithoutRemote, topologyId, segment, commandInvocationId, wrappedValue, null, valueMatcher, internalMetadata);
