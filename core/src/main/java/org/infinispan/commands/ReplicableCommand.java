...
public interface ReplicableCommand {
    ...
    * @deprecated Since 9.0, split into {@link #invokeAsync()} for non-visitable commands and by the
    * {@link org.infinispan.interceptors.impl.CallInterceptor} for visitable commands.
    */
   @Deprecated
    ...
    * @deprecated since 10.0 no longer necessary with protostream based marshaller
    */
   @Deprecated
   byte getCommandId();
