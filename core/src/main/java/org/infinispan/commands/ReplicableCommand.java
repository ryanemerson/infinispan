...
public interface ReplicableCommand {
    ...
    * @since 10.1
    */
   // TODO does isRemote make sense anymore? Command should always be invoked on remote. Can we use origin?
   default CompletableFuture<Object> invokeAsync(ComponentRegistry registry, boolean isRemote) throws Throwable {
      return invokeAsync(registry);
   }
    ...
    *
    * @since 9.0
    * @deprecated since 10.1, please use {@link #invokeAsync(ComponentRegistry, boolean)} instead.
    */
   @Deprecated
