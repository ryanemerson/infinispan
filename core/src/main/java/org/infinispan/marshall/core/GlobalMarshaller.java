...
public class GlobalMarshaller implements StreamingMarshaller {
   ...
   public GlobalMarshaller(Marshaller userMarshaller) {
   ...
   public void start() {
      if (userMarshaller == null) {
         ...
         StreamingMarshaller marshaller = new UserJbossMarshaller(this, classResolver);
         marshaller.start();
         this.userMarshaller = marshaller;
         internalExts = InternalExternalizers.load(this, gcr, cmdFactory);
      } else {
         internalExts = InternalExternalizers.load(userMarshaller, gcr, cmdFactory);
      }
      ...
      externalExts = UserExternalizers.load(gcr.getGlobalConfiguration());
