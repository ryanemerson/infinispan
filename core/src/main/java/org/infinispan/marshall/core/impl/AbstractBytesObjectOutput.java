...
/**
 * Array backed abstract {@link ObjectOutput} implementation that provides all methods of {@link ObjectOutput}, except
 * {@link ObjectOutput#writeObject(Object)}.
 *
 * @author Ryan Emerson
 * @since 10.0
 */
public abstract class AbstractBytesObjectOutput implements ObjectOutput {

   protected byte[] bytes;
   protected int pos;

   protected AbstractBytesObjectOutput(int size) {
