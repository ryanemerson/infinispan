...
abstract class AbstractMarshallableMapWrapper<K, V> {
   ...
   public abstract static class Marshaller extends GeneratedMarshallerBase implements ProtobufTagMarshaller<AbstractMarshallableMapWrapper<?, ?>> {
      ...
      @Override
      public AbstractMarshallableMapWrapper<?, ?> read(ReadContext ctx) throws IOException {
      ...
      @Override
      public void write(WriteContext ctx, AbstractMarshallableMapWrapper<?, ?> wrapper) throws IOException {
         if (kvpMarshaller == null)
            kvpMarshaller = ((SerializationContextImpl) ctx.getSerializationContext()).getMarshallerDelegate(org.infinispan.util.KeyValuePair.class);
