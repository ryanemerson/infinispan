...
//
///**
// * An abstract class which provides the basis of {@link Map} wrapper implementations which need to
// * delegate the marshalling of a {@link Map}'s entries to a {@link
...
//            kvpMarshaller = ((SerializationContextImpl) ctx).getMarshallerDelegate(KeyValuePair.class);
//
