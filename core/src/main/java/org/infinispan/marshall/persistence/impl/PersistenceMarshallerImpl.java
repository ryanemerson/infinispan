...
public class PersistenceMarshallerImpl implements PersistenceMarshaller {
   ...
   public void start() {
      ...
      registerProtoFile("schema/persistence.core.proto");

      // Register marshallers which cannot be initiated from a static context via @AutoProtoSchemaBuilder
      serializationContext.registerMarshaller(new AtomicKeySetImpl.KeyMarshaller(this));
      serializationContext.registerMarshaller(new AtomicKeySetImpl.Marshaller(gcr, this));
      serializationContext.registerMarshaller(new AtomicMapMarshaller(this));
   }
