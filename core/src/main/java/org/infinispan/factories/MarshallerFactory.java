 ...
 * @since 4.0
 */
@DefaultFactoryFor(classes = {GlobalMarshaller.class, PersistenceMarshaller.class, StreamAwareMarshaller.class},
...
public class MarshallerFactory extends AbstractComponentFactory implements AutoInstantiableFactory {
   ...
   public Object construct(String componentName) {
      ...
      if (componentName.equals(GlobalMarshaller.class.getName())) {
