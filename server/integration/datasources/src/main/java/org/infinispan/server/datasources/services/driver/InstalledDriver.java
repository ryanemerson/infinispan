...
public final class InstalledDriver {
    ...
    * @param dataSourceClassName the name of the {@link javax.sql.DataSource} implementation class
   ...
   public InstalledDriver(final String driverName, final ModuleIdentifier moduleName, final String driverClassName,
                          final String dataSourceClassName, final int majorVersion, final int minorVersion,
    ...
    *
    * @return {@code true} if the driver was loaded from a deployment unit; {@code false} if it was loaded from a module
    * on the module path
    */
