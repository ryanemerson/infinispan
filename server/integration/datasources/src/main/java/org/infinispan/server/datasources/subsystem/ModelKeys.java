...
class ModelKeys {
   ...
   static final String TRANSACTION_ISOLATION = "transaction-isolation";

   static final String URL_DELIMITER = "url-delimiter";

   static final String URL_PROPERTY = "url-property";
   ...
   static final String ENLISTMENT_TRACE = "enlistment-trace";
   ...
   static final String REAUTH_PLUGIN = "reauth-plugin";
