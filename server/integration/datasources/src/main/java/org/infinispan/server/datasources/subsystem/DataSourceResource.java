...
class DataSourceResource {
   ...
   static final SimpleAttributeDefinition CONNECTION_URL = new SimpleAttributeDefinitionBuilder(ModelKeys.CONNECTION_URL, ModelType.STRING)
         .setAllowExpression(true)
         .build();

   static final SimpleAttributeDefinition DRIVER = new SimpleAttributeDefinitionBuilder(ModelKeys.DRIVER, ModelType.STRING)
         .setAllowExpression(true)
         .build();

   static final SimpleAttributeDefinition JNDI_NAME = new SimpleAttributeDefinitionBuilder(ModelKeys.JNDI_NAME, ModelType.STRING)
         .setAllowExpression(true)
   ...
   static final SimpleAttributeDefinition PASSWORD = new SimpleAttributeDefinitionBuilder(ModelKeys.PASSWORD, ModelType.STRING, true)
         .setAllowExpression(true)
   ...
   static final SimpleAttributeDefinition STATISTICS_ENABLED = new SimpleAttributeDefinitionBuilder(ModelDescriptionConstants.STATISTICS_ENABLED, ModelType.BOOLEAN, true)
         .setDefaultValue(new ModelNode(false))
         .setAllowExpression(true)
         .build();

   static final SimpleAttributeDefinition USE_JAVA_CONTEXT = new SimpleAttributeDefinitionBuilder(ModelKeys.USE_JAVA_CONTEXT, ModelType.BOOLEAN, true)
         .setDefaultValue(new ModelNode(true))
         .setAllowExpression(true)
         .build();

   static final SimpleAttributeDefinition USERNAME = new SimpleAttributeDefinitionBuilder(ModelKeys.USERNAME, ModelType.STRING, true)
         .setAllowExpression(true)
         .addAccessConstraint(SensitiveTargetAccessConstraintDefinition.CREDENTIAL)
         .addAccessConstraint(DS_SECURITY_DEF)
         .build();
