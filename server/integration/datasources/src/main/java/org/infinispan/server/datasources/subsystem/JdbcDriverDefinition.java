...
class JdbcDriverDefinition extends SimpleResourceDefinition {

   private static final PathElement PATH_DRIVER = PathElement.pathElement(ModelKeys.JDBC_DRIVER);
   ...
   private JdbcDriverDefinition() {
      ...
      ApplicationTypeConfig atc = new ApplicationTypeConfig(DataSourcesExtension.SUBSYSTEM_NAME, ModelKeys.JDBC_DRIVER);
