...
public class CrashedMemberDetectorTest extends SingleCacheManagerTest {
   ...
   public void testDetectCrashedMembers() {
      var address1 = JGroupsTopologyAwareAddress.random("a");
      var address2 = JGroupsTopologyAwareAddress.random("b");
      var address3 = JGroupsTopologyAwareAddress.random("c");
      ...
      oldMembers.add(JGroupsTopologyAwareAddress.random());
      oldMembers.add(JGroupsTopologyAwareAddress.random());
      oldMembers.add(JGroupsTopologyAwareAddress.random());

      List<Address> newMembers = new ArrayList<>();
      newMembers.add(JGroupsTopologyAwareAddress.random());
      newMembers.add(JGroupsTopologyAwareAddress.random());
